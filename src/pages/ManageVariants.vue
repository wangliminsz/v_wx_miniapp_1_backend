            ...
            <div class="bg-dark-200 rounded-md p-4 border border-dark-100">
              ...
              <div class="flex flex-wrap gap-2 mb-3">
                <div
                  ...
                  <div
                    class="absolute inset-0 bg-dark-900/60 opacity-0 group-hover:opacity-100 flex items-center justify-center">
                    <button @click="removeAsset(asset.id)" class="text-white hover:text-red-400">
